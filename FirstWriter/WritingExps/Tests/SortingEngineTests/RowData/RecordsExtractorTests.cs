...
public class RecordsExtractorTests
{
    ...
    public void Extractor_ShouldAlwaysExtract()
    {
        ...
        var result = extractor.ExtractRecords(inputSpan, storage);
    ...
    public void Exp()
    {
        string responseStr = File.ReadAllText(@"TestData\ResponseWithStringErrors.json");
        // string invoice = Resources.ResourceManager.GetString(invoiceName);
